...
major_1_return <- callModule(input_major_module, "1", id = 1, parent_session = session, major_names = major_names, major_data = major_data)
...
major_2_return <- callModule(input_major_module, "2", id = 2, parent_session = session, major_names = major_names, major_data = major_data)
...
major_3_return <- callModule(input_major_module, "3", id = 3, parent_session = session, major_names = major_names, major_data = major_data)
